...
#define CXT_MACRO_MEMBER(n, t, d) CXT_MACRO_CHECK_CMDLINE_PARAMETER(n, t, d)
  ...
  void OpencvCamNode::loop()
  {
    ...
    while (rclcpp::ok() && !canceled_.load())
    {
      ...
      {
        auto image_msg = create_image_msg(stamp, frame, cxt_.camera_frame_id_);
...
#undef SHOW_ADDRESS
  ...
  sensor_msgs::msg::Image::UniquePtr OpencvCamNode::create_image_msg(rclcpp::Time &stamp, cv::Mat &frame, std::string frame_id)
  {
